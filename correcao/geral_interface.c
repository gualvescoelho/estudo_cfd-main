...
void desvio_padrao(int qtd_colunas, int linhas, int itmin, int escolha, char nome_in[50], char nome_out[250], int l, int desejado); 
...
void correlacao(int desejado_1, int desejado_2, int ponto_1, int ponto_2, int sub, char nome_in[50],int colunas, int linhas, int itmin, char nome_out[250]);
...
void main(int argc, char *argv[])
{
	...
	arq_saida_vel_media_x(("%s/vel_media/vel_media_x", argv[8]));
	
	arq_saida_vel_media_y(("%s/vel_media/vel_media_y", argv[8]));

	arq_saida_vel_media_z(("%s/vel_media/vel_media_z", argv[8]));

	arq_saida_vel_media_todas(("%s/vel_media/vel_media_geral", argv[8]));
	
	arq_saida_coordenadas(("%s/coordenadas/coordenadas", argv[8]));
	printf("%s/coordenadas/coordenadas", argv[8]);
	system("pause");
	arq_saida_grafico_x();
	...
	/*
	if(ok_correlacao == 1)
		correlacao(desejado_1, desejado_2, ponto_1, ponto_2, sub, nome_in[50], colunas, linhas, itmin, nome_out[250]);
	*/
...
void arq_saida_desvio_padrao(int qtd_coord, int linhas, int itmin, char nome_in[50], char nome_out[250], int l, int desejado)
{
	int escolha;
...
void desvio_padrao(int colunas, int linhas, int itmin, int escolha, char nome_in[50], char nome_out[250], int l, int desejado)
{
	FILE *arq_out, *arq;
	double soma = 0, media = 0, c_x = 0, c_y = 0, c_z = 0, aux = 0;
